...
class LeftViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.row == 0 {
          ...
          //  self.navigationController?.setViewControllers([aboutVC], animated: false)
...
//            
//            let aboutVC = SettingStoryBoard.instantiateViewController(withIdentifier: "SettingVC") as! Setting
